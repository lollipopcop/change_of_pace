...
layer_x(layer_front, lerp(0, obj_camera.x - camera_offset, 0.5));
layer_x(layer_middle, lerp(0, obj_camera.x - camera_offset, 0.75));
layer_x(layer_back, lerp(0, obj_camera.x - camera_offset + sun_offset, 0.9));